...
<head>
	...
	<link rel="icon" type="image/png" href="plugins/i/favicon.png">
	<link rel="apple-touch-icon-precomposed" href="/plugins/i/app-icon72x72@2x.png">
	<meta name="apple-mobile-web-app-title" content="Amaze UI" />
	<link rel="stylesheet" href="/plugins/css/amazeui.min.css" />
...
<script type="text/javascript"  src="/plugins/js/amazeui.min.js"></script>
