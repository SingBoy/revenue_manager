                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a type="button" href="${pageContext.request.contextPath}/user/doBusinessUpdate/${item.id}?keyword=${queryBean.keyword}&currentPage=${queryBean.currentPage}&pageSize=${queryBean.pageSize}" class="am-btn am-btn-default am-btn-xs am-text-secondary" ><i  class="am-icon-pencil-square-o"></i> 编辑</a>
...
<script type="text/javascript">
    ...
    function addButton(){
        window.location="${pageContext.request.contextPath}/user/doBusinessSave/?currentPage=${queryBean.currentPage}&pageSize=${queryBean.pageSize}";
    }
    function editButton(id){
        window.location="${pageContext.request.contextPath}/user/doBusinessUpdate/"+id+"?currentPage=${queryBean.currentPage}&pageSize=${queryBean.pageSize}";
    }
        ...
        if(id == null){
            ...
            if(ids !=null){
                if (confirm("你确认要删除选中的数据吗？")){
                    window.location = "${pageContext.request.contextPath}/user/deleteBusiness/"+ids +
            ...
            if (confirm("你确认要删除吗？")){
                window.location = "${pageContext.request.contextPath}/user/deleteBusiness/"+id +
                    "?keyword="+$("#keyword").val()+"&currentPage="+${queryBean.currentPage}+"&pageSize="+${queryBean.pageSize};
            }
        }
    }
