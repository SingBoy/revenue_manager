            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
                        <form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/user/saveCustomer" method="post">
                            ...
                            <div class="am-form-group">
                                <label for="nick-name" class="am-u-sm-3 am-form-label">名称</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="nick-name" name="nickname" placeholder="输入名称">
                                </div>
                            </div>
                            <%--
                                                        <div class="am-form-group">
